...
defineProps({ expiredOwners: Array });

const deleteOwner = id => {
    router.post(route('admin.expired-owners.destroy', { owner: id }), undefined, {
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">期限切れOwner一覧</h2>
        </template>
                            ...
                            <div class="container md:px-5 mx-auto">
                                ...
                                <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                                    <table class="table-auto w-full text-left whitespace-no-wrap">
                                        ...
                                        <tbody>
                                            <tr v-for="owner in expiredOwners.data" :key="owner.id">
                                    ...
                                    <Pagination class="mt-6" :links="expiredOwners.links"></Pagination>
                                </div>
                            </div>
                        </section>
                    </div>
